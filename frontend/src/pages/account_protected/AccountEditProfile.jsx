...
const AccountEditProfile = () => {
  ...
  const {
    ...
    onSubmit: (values) => {
      axiosTokenIntercept.patch(`/api/user/`, values).then((result) => {
      ...
      <ProfileBackgroundHero>
        ...
        <div className="row justify-content-between align-items-end mb-3">
          ...
          <PurpleButton
            className="col-3 p-2"
            onClick={() => {
              navigate("/account/edit/changepassword");
            }}
          >
            Change password
          </PurpleButton>
        ...
        <form
          ...
          className="row border-top border-info p-3"
        >
          <div className="col-12 col-lg-6 my-3">
            <label htmlFor="email" className="mb-1 text-warning">
              Email
            </label>
            <input
              id="email"
            ...
            />
            {errors.email && touched.email ? (
              <div className="feedback-invalid mt-2">{errors.email}</div>
            ) : null}
          </div>
          <div className="col-12 col-lg-6 my-3">
            <label htmlFor="username" className="mb-1 text-warning">
              Username
            </label>
            <input
              id="username"
            ...
            />
            {errors.username && touched.username ? (
              <div className="feedback-invalid mt-2">{errors.username}</div>
            ) : null}
          </div>

          <div className="col-12 col-lg-6 my-3">
            <label htmlFor="first_name" className="mb-1 text-warning">
              First Name *
            </label>
            <input
              id="first_name"
            ...
            />
            {errors.first_name && touched.first_name ? (
              <div className="feedback-invalid mt-2">{errors.first_name}</div>
            ) : null}
          </div>
          <div className="col-12 col-lg-6 my-3">
            <label htmlFor="last_name" className="mb-1 text-warning">
              Last Name *
            </label>
            <input
              id="last_name"
            ...
            />
            {errors.last_name && touched.last_name ? (
              <div className="feedback-invalid mt-2">{errors.last_name}</div>
            ) : null}
          </div>

          <div className="col-12 col-lg-6 my-3">
            <label htmlFor="birthdate" className="mb-1 text-warning">
              Birthdate
            </label>
            <input
              disabled
            ...
            />
            {errors.birthdate && touched.birthdate ? (
              <div className="feedback-invalid mt-2">{errors.birthdate}</div>
            ) : null}
          </div>

          <div className="col-12 col-lg-6 my-3">
            <label htmlFor="birthplace" className="mb-1 text-warning">
              Birthplace *
            </label>
            <input
              id="birthplace"
            ...
            />
            {errors.birthplace && touched.birthplace ? (
              <div className="feedback-invalid mt-2">{errors.birthplace}</div>
            ) : null}
          </div>

          <div className="col-12 d-flex align-items-end mt-4 justify-content-end">
            <PurpleButton className="btn btn-primary px-3 py-2" type="submit">
              EDIT PROFILE
            </PurpleButton>
          </div>
        </form>
