...
export const apiBaseUrl = `https://${import.meta.env.VITE_API_URL}`;
export const mediaBaseUrl = `https://${import.meta.env.VITE_API_URL}`;
export const apiStaticURL = `/static/media/`;
